          ...
          <div className={S.ecosystemPerformance}>
            <div className={S.ecosystemSection}>
              <div className={S.ecosystemStatCard}>
                <img height="200px" className={S.ecosystemStatIcon} src="https://user-images.githubusercontent.com/28320272/205302299-2e2a2c08-d071-447d-9c57-b139583ac9a2.gif" />
            ...
            <div className={S.ecosystemSection}>
              <div className={S.ecosystemStatCard}>
                <img height="200px" className={S.ecosystemStatIcon} src="https://user-images.githubusercontent.com/28320272/205301350-28c38449-1e3d-41d1-9816-790008e4fbee.gif" />
            ...
            <div className={S.ecosystemSection}>
              <div className={S.ecosystemStatCard}>
                <img height="200px" className={S.ecosystemStatIcon} src="https://user-images.githubusercontent.com/28320272/205301608-742949ad-63b4-4cf0-9813-707459650bee.gif" />
            ...
            <div className={S.ecosystemSection}>
              <div className={S.ecosystemStatCard}>
                <img height="200px" className={S.ecosystemStatIcon} src="https://user-images.githubusercontent.com/28320272/205301746-297295d4-a576-4d28-9d7c-2feada68aa5f.gif" />
            ...
            {graph.dealsSealedBytes ? (
              <div className={S.ecosystemSection}>
                <div className={S.ecosystemStatCard}>
                  <img height="200px" className={S.ecosystemStatIcon} src="https://user-images.githubusercontent.com/28320272/205099484-e268f273-8fe6-473b-863e-1a8d4e35636d.gif" />
            ...
            <div className={S.ecosystemSection}>
              <div className={S.ecosystemStatCard}>
                <img height="200px" className={S.ecosystemStatIcon} src="https://user-images.githubusercontent.com/28320272/205303934-d95ea7a6-e13d-482a-94a4-cedb99998568.gif" />
            ...
            <div className={S.ecosystemSection}>
              <div className={S.ecosystemStatCard}>
                <img height="200px" className={S.ecosystemStatIcon} src="https://user-images.githubusercontent.com/28320272/205304639-59eee09d-3b92-4952-b67f-8329500817b7.gif" />
